module.exports = {
  apps: [
    ...
    },
    {
      ...
      log_file: "./logs/email-compose-workers.log",
      out_file: "./logs/email-compose-workers-out.log",
      error_file: "./logs/email-compose-workers-error.log",
      log_date_format: "YYYY-MM-DD HH:mm:ss Z",
      merge_logs: false,
      kill_timeout: 5000,
      restart_delay: 2000,
