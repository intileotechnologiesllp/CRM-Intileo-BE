...
exports.generateExistingDealPerformanceDataForSave = async (
  ownerId,
  role,
  existingxaxis,
  existingyaxis,
...
exports.generateDealConversionDataForSave = async (
  ...
  // Get total count of distinct x-axis values
  const totalCountResult = await Deal.findAll({
    where: baseWhere,
    attributes: [
      [
  ...
  // Convert to array
  const formattedResults = Object.values(groupedData);
...
//for Duration
// Helper function to generate activity performance data with pagination
exports.generateDealDurationData = async (
  ownerId,
  role,
  xaxis,
  yaxis,
